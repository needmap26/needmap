      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full flex flex-col gap-12">
        <div className="space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#E5E3DB]">
            <div className="text-lg text-text-secondary leading-relaxed font-medium space-y-4">
              <p>
                NeedMap is a data-driven platform designed to solve real-world coordination gaps between NGOs and volunteers. It leverages AI and real-time mapping to identify urgent needs, optimize resource allocation, and drive measurable social impact at scale.
              </p>
              <p>
                For any queries or support, contact:<br />
                <a href="mailto:needmap26@gmail.com" className="text-primary hover:underline font-bold">needmap26@gmail.com</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-[#E5E3DB] flex flex-col sm:flex-row gap-6 items-start sm:items-center">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-4 flex-wrap">
                <a 
                  href="https://www.linkedin.com/in/harshil-2b5686390" 
                  target="_blank" 
                ...
                <a 
                  href="mailto:hsllife75@gmail.com" 
